...
import Transcend from '../transcend.min.js';

// TODO:
const AEVOS_API_KEY = "TODO"
...
function verifySignatures() {
    ...
    console.log("Transcend.verifySignature(EXAMPLE_VALID):")
    console.log(Transcend.verifySignature(EXAMPLE_VALID));

    console.log("Transcend.verifySignature(EXAMPLE_INVALID_HASH):")
    console.log(Transcend.verifySignature(EXAMPLE_INVALID_HASH));
}
...
function apiCalls() {
    console.log("\n\n==== Get History ====")
    Transcend.getHistory(AEVOS_API_KEY)
        .then(data => {
            console.log = (msg) => {
